...
当前 Demo 包括 `AgentGate`、`Agent Trace Console`、`AnswerRank`、`CopilotBurn`、`MCP Gateway Readiness Scanner`、`ModelShift`、`Prompt Drift Lab`、`Release Note Impact Radar` 和 `Workspace Agent Route Planner`，都已内置在 `demos/<demo-id>/`，部署到 Pages 后可以直接从展示站打开演示。
