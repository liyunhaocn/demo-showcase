...
const output = path.join(showcaseRoot, 'demos', 'mcp-gateway-readiness-scanner')
...
console.log(`Built MCP Gateway Readiness Scanner static demo into ${path.relative(showcaseRoot, output)}`)
